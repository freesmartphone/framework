...
#=========================================================================#
    ...
    def __init__( self, *args, **kwargs ):
        ...
        self._channels[ "UNSOL" ] = UnsolicitedResponseChannel( self.pathfactory, "/dev/mux0" ) # might also be callchannel
        self._channels[ "MISC" ] = MiscChannel( self.pathfactory, "/dev/mux4" ) # needs to parse unsolicited
        self._channels[ "CALL" ] = MiscChannel( self.pathfactory, "/dev/mux5" )
