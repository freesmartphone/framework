...
from ficmodem import *
############################### gsm functionality
'''
PN=+4917200000
DB="dbus-send --system --print-reply --type=method_call --dest=org.mobile /org/mobile/GsmPhone"
$DB org.mobile.Phone.DeviceGetInfo
$DB org.mobile.Phone.SimSendAuthCode string:2222
$DB org.mobile.Phone.SimGetAuthStatus
...
class GsmPhone(FicModem, NotifyObject):

	def __init__(self, bus):
		FicModem.__init__(self, bus)
		NotifyObject.__init__(self,
			object_path='/org/mobile/GsmPhone',
			bus_name=BusName(DBUS_NAME, bus=bus),
			)
...
if __name__ == '__main__':
	...
	openlog('pygsmd', LOG_NDELAY|LOG_PID|LOG_PERROR, LOG_DAEMON,)
	DBusGMainLoop(set_as_default=True)
	mainloop = MainLoop()
	daemon = GsmPhone(InitBus())
	mainloop.run()
	closelog()
# vim:tw=0:nowrap
